...
function CarouselData ({slides}) {
    ...
    return (
        ...
        <main className="flex justify-center items-center mx-auto h-screen gap-8 px-4">
            ...
            >
            <FontAwesomeIcon icon={faArrowLeft} className="text-green-600 transition-transform duration-200 ease-out hover:-translate-y-2 hover:scale-105" style={{filter: 'drop-shadow(2px 2px 2px black)'}}/>
            </button>
            ...
            <Link to="/kata-gallery">
                <button className="bg-green-600 border border-white m-2 p-2 rounded-sm text-white font-bold cursor-pointer transition-transform duration-200 ease-out hover:-translate-y-2 hover:scale-100">Go to Kata Gallery</button>
            </Link>
         ) : null}
            </section>
         ...
         >
            <FontAwesomeIcon icon={faArrowRight} className="text-green-600 transition-transform duration-200 ease-out hover:-translate-y-2 hover:scale-105" style={{filter: 'drop-shadow(2px 2px 2px black)'}}/>
            </button>
        </main>
